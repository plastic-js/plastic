...
import { computed, effect, h, signal } from './jsx-runtime.js'

// ========== 示例 1: 基础计数器 ==========
const count = signal(0)

const BasicCounter = ()=> <div>
	<p>Count: {()=> count()}</p>
...
const App = ()=> <div style='padding: 20px;'>
