...
/**
 * 检查值是否是 signal/computed（可调用的响应式值）
 */
function isSignal(value) {
    return typeof value === 'function' && !(value instanceof Element)
}
...
function h(tag, props = {}, ...children) {
    ...
    // 分离并处理属性
    const { eventListeners, dynamicProps, staticProps } = separateProps(props)
...
function separateProps(props) {
    ...
    return { eventListeners, dynamicProps, staticProps }
}
